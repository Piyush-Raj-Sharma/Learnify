...
const CallToAction = () => {
  return (
    <div className = "flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0">
      <h1 className="text-xl md:text-4xl text-gray-800 dark:text-white font-semibold">Learn anything, anytime, anywhere</h1>
      <p className="text-gray-500 sm:text-sm md:text-base">
        ...
        veniam aliqua proident expedit. Dolor excepteur excepteur
      </p>
